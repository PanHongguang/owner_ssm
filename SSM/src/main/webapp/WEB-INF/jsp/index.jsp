...
<head>
    ...
    <script src="${ctx}/js/Globals.js"></script>
...
<div id="carousel-example-generic" class="carousel slide"
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <a href="${ctx}/user/showUser/1">
                <img src="${ctx}/img/spring.png" alt="">
            </a>
        </div>
        <div class="item">
            <img src="${ctx}/img/ngix.gif" alt="...">
            <div class="carousel-caption">
                <p class="text-primary">
                    Ngix搭建实例
                </p>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <p>
                        <a class="btn btn-primary" href="${ctx}/jsonp.jsp">JsonP</a>
                        <a class="btn btn-info" href="${ctx}/redis/showRedis.jsp">redisDemo</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        <b>
                                            <a href="${ctx}/user/showUser/${u.userId}">${u.username}</a>
                                        </b>
                                        <br/>
                                            ${u.description}
                                    </div>
...
<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myModalLabel_register">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="registerUserForm" action="${ctx}/index/register">
